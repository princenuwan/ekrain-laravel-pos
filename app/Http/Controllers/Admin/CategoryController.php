...
class CategoryController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect()->route('category.list')->with('alert', ['type' => 'success', 'message' => 'Added Category']);
    }
    ...
    public function update(Request $request){
        ...
        return redirect()->route('category.list')->with('alert', ['type' => 'success', 'message' => 'Updated Category']);
    }
